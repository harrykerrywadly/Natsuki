...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="✅ Hannah Updates", url="https://t.me/Hannah_Updates"
        ),
        InlineKeyboardButton(
            text="💬 Official Supporter", url="https://t.me/weraofficialbot"
        ),
    ],
    [
        InlineKeyboardButton(
            text="➕ Add To Me Your Group ➕",
            url="t.me/Hannah_group_bot?startgroup=true",
        ),
    ],
]

NATSUKI_IMG = "https://telegra.ph/file/05b3904ce7e3b9eed917f.jpg"

HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/05b3904ce7e3b9eed917f.jpg)
...
Support them  [WERA](t.me/weraofficialbot)"""
...
def Natsuki_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Hannah Updates.* "
            f"\n\n Join [Hannah Updates](https://t.me/Hannah_Updates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by contact [Hannah Official Support](https://t.me/weraofficialbot).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
